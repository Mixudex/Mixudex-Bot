...
```bash
bash <(curl -sL https://raw.githubusercontent.com/Mixudex/Mixudex-Bot/main/install_go.sh)
```
...
Proyecto personalizado por Mixudex.
Versión inicial de migración de marca.
